...
experiences:
  ...
  - company: "Ardecs"
    ...
    keyAchievements:
      ...
      - Внедрение aggregation pipline (Mongo), что позволило перенести часть сложной логики агрегации на уровень БД и поднять rps у сервисов 
    technologiesUsed:
      - Java 11, FastAPI, React, PostgreSQL
      - Spring Boot
      - Apache Kafka
      - Mongo DB
